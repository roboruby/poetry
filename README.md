...
### poetry-core — the engine and the component DSL
...
### poetry-charts — server-rendered SVG charts
...
### poetry-agent — the agent surfaces
...
### poetry-extract — domain in, theme out
...
### poetry-simple_form — the migration bridge
